...
<div className="portion2">
    <div className="div px-25 py-10 border-2 m-6 bg-black opacity-70">
        <h2 className="font-bold">Secure Your Assets</h2>
        <br></br>
        <p className="py-2 px-25 border-2 m-3">Ai-based law simplification</p>
        <p className="py-2 px-25 border-2 m-3">OCR document analysis</p>
        <p className="py-2 px-25 border-2 m-3">Urdu and Roman Urdu support</p>
        <p className="py-2 px-25 border-2 m-3">Consultation with Experts</p>
